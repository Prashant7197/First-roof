...
const FilterModal = ({ filterModalSharedValue1, filterModalSharedValue2 }) => {
    ...
    const [selectedCredtedWithin, setSelectedCreatedWithin] = React.useState("")
                                            ...
                                            return (
                                                <TextButton
                                                    ...
                                                    contentContainerStyle={{
                                                        ...
                                                        backgroundColor: item?.id == selectedCredtedWithin ? COLORS.primary3 : null
                                                    }}
                                                    labelStyle={{
                                                        color: item?.id == selectedCredtedWithin ? COLORS.white : COLORS.black,
                                                        ...FONTS.body3
                                                    }}
                                                    onPress={() => {
